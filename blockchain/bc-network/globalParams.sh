...
exportChannel1Params () {
  ...
  export CHANNEL_CREATOR='Donor10'
  export CHANNEL_ORDERER_ORG='CharityOrganization'
  ...
  export ORDERER_CA="$NODE_PATH/msp/tlscacerts/tlsca.CharityOrganization-cert.pem"
  export CHANNEL_ORDERER="$CHANNEL_ORDERER_NAME.$CHANNEL_ORDERER_ORG"
  export ORDERER_HOST='localhost'
  export ORDERER_PORT='108'
  export CHANNEL_MEMBER1_NODE='ServiceProvider'
  export CHANNEL_MEMBER1_ORG='Donor10'
  
  export CHANNEL_MEMBER1_NODE='charity10node'
  export CHANNEL_MEMBER1_ORG='Charity10'
  
  export NUM_MEMBERS='2'
  export NUM_ANCHORS='0'
  export CHANNEL_SIZE='2'
  export CHANNEL_ORGS=(Donor10 Charity10)
  
  export CHANNEL_ORG0_NODES=(ServiceProvider)
  
  export CHANNEL_ORG1_NODES=(charity10node)
